...
public class RegionOfIntrest {
    ...
    public RegionOfIntrest(int[] coor, int roiNum, int frameNum, int roi_size ){
        this.coor=coor; // Coordinate of the center of the cell
        this.roiNum=roiNum; // Coordinate of the ROI in the intracellular space of the cell
    ...
    public void setRoiIntracellular(int kernel_size, LinkedList<ImagePlus>ijFrames) {
        // Crop image to ROI
        ImagePlus frame_ = new ImagePlus();
        frame_ = ijFrames.get(frameNum);
        ...
        coorRoi[0] = coor[0]-Math.round(roi_size/2) + xMax;
        coorRoi[1] = coor[1]-Math.round(roi_size/2) + yMax;
    ...
    public void saveRoi(LinkedList<ImagePlus>ijFrames, LinkedList<Integer> idxFramesInFocus){
